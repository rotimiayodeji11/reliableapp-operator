...
*/}}
{{- define "reliableapp-operator.name" -}}
...
*/}}
{{- define "reliableapp-operator.fullname" -}}
...
*/}}
{{- define "reliableapp-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "reliableapp-operator.resourceName" -}}
{{- $fullname := include "reliableapp-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "reliableapp-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "reliableapp-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
